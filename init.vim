...
highlight Search guibg=White guifg=White ctermbg=62 ctermfg=White
...
let g:ycm_key_list_select_completion   = ['<C-j>', '<C-n>', '<Down>', '<Tab>']
let g:ycm_key_list_previous_completion = ['<C-k>', '<C-p>', '<Up>', '<S-tab>']
...
" golint
set rtp+=/Users/gordcurrie/go/src/golang.org/x/lint/misc/vim
" run on golint on :w
